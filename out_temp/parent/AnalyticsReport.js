...
export default function AnalyticsReport() {
  ...
  return /* @__PURE__ */ React.createElement(View, { style: styles.section }, /* @__PURE__ */ React.createElement(View, { style: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 15 } }, /* @__PURE__ */ React.createElement(Ionicons, { name: "bar-chart", size: 20, color: "#2D3436" }), /* @__PURE__ */ React.createElement(Text, { style: [styles.sectionTitle, { marginBottom: 0 }] }, "Household Analytics")), /* @__PURE__ */ React.createElement(View, { style: styles.metricsGrid }, /* @__PURE__ */ React.createElement(View, { style: styles.metricCard }, /* @__PURE__ */ React.createElement(Text, { style: styles.metricValue }, completionRate.toFixed(0), "%"), /* @__PURE__ */ React.createElement(Text, { style: styles.metricLabel }, "Chores Completed"), /* @__PURE__ */ React.createElement(View, { style: styles.miniBarBg }, /* @__PURE__ */ React.createElement(View, { style: [styles.miniBarFill, { width: `${completionRate}%`, backgroundColor: completionRate > 70 ? "#00b894" : "#fdcb6e" }] }))), /* @__PURE__ */ React.createElement(View, { style: styles.metricCard }, /* @__PURE__ */ React.createElement(Text, { style: [styles.metricValue, { color: "#E17055" }] }, spendingRatio.toFixed(0), "%"), /* @__PURE__ */ React.createElement(Text, { style: styles.metricLabel }, "Earnings Spent"), /* @__PURE__ */ React.createElement(View, { style: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 4 } }, /* @__PURE__ */ React.createElement(Text, { style: styles.helperText }, spendingRatio > 80 ? "High Spenders" : "Great Savers"), /* @__PURE__ */ React.createElement(Ionicons, { name: spendingRatio > 80 ? "cash-outline" : "business-outline", size: 12, color: "#B2BEC3" })))), /* @__PURE__ */ React.createElement(View, { style: styles.ribbonCard }, /* @__PURE__ */ React.createElement(View, { style: styles.ribbonIcon }, /* @__PURE__ */ React.createElement(Ionicons, { name: "trophy", size: 24, color: "#D97706" })), /* @__PURE__ */ React.createElement(View, { style: styles.ribbonContent }, /* @__PURE__ */ React.createElement(Text, { style: styles.ribbonTitle }, "Top Earner"), /* @__PURE__ */ React.createElement(Text, { style: styles.ribbonSub }, topEarner?.name || "No one yet", " (", topEarner?.tokens || 0, " tokens)"))));
}
